...
import { ICharacterAttributes } from '../../database/models';
import { CharacterAttributeProvider } from '../../database/providers';

interface IParamsProps {
    id?: number,
}
interface IBodyProps extends Omit<ICharacterAttributes, 'id'> {}
...
export const updateById = async (req: Request<IParamsProps,{},IBodyProps>, res: Response) => {
	...
	const result = await CharacterAttributeProvider.updateById(req.params.id, req.body);
